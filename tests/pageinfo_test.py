import unittest
from customblocks.utils.pageinfo import PageInfo
from customblocks.utils.hyperscript import E
...
class PageInfo_Test(unittest.TestCase):
    ...
    @unittest.skip("Media Wiki robot rules halt test")
    ...
    def test_absolute_nourl_unmodified(self):
        ...
        self.assertEqual(info.absolute("next.html"), "next.html")

    def test_absolute_relativeToPage(self):
        info = PageInfo("<html />", url="http://site.com/path/page.html")
        self.assertEqual(info.absolute("next.html"), "http://site.com/path/next.html")

    def test_absolute_relativeToRoot(self):
        info = PageInfo("<html />", url="http://site.com/path/page.html")
        self.assertEqual(info.absolute("/next.html"), "http://site.com/next.html")

    def test_absolute_alreadyAbsolute(self):
        info = PageInfo("<html />", url="http://site.com/path/page.html")
        self.assertEqual(info.absolute("https://othersite.org/next.html"), "https://othersite.org/next.html")
    ...
    def test_title_override(self):
        info = PageInfo(self.html(E("html", E("head", E("title", "Not shown")))), title="Overriden title")

        self.assertEqual(info.title, "Overriden title")

    def test_description_override(self):
        info = PageInfo(
            self.html(E("html", E("head", E("meta", property="description", content="Not shown")))),
    ...
    def test_sitename_override(self):
        info = PageInfo(
            self.html(E("html", E("head", E("meta", property="og:site_name", content="Not shown")))),
    ...
    def test_siteicon_override(self):
        info = PageInfo(self.html(E("html")), siteicon="overriden.png")

        self.assertEqual(info.siteicon, "overriden.png")

    def test_siteicon_override_withUrl(self):
        info = PageInfo(self.html(E("html")), siteicon="overriden.png", url="http://site.com/path/file.html")

        self.assertEqual(info.siteicon, "overriden.png")

    def test_image_override_withUrl(self):
        info = PageInfo(
            self.html(E("html", E("head", E("meta", property="og:image", content="notshown.jpg")))),
            image="overriden.jpg",
    ...
    def test_image_cached(self):
        info = PageInfo(
            self.html(E("html", E("head", E("meta", property="og:image", content="image.jpg")))),
            url="http://site.com/path/file.html",
        )
