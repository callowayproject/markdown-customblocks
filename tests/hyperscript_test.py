...
from customblocks.utils.hyperscript import E, Markdown
from textwrap import dedent


class ETest(unittest.TestCase):
    def assertXml(self, e, expected):
        self.assertMultiLineEqual(etree.tostring(e, "unicode"), dedent(expected.strip()))
    ...
    def test_child_iterators(self):
        e = E("ul", (E("li", item) for item in "ABC"))
        self.assertXml(
            e,
            """\
    ...
    def test_markdown_customParser(self):
        ...
        e = E("", Markdown("""!!! danger "Caution"\nshit happens""", parser=md.parser))
        self.assertXml(
            e,
            """\
