...
from customblocks.utils.fetcher import Fetcher
...
class Fetcher_Test(unittest.TestCase):
    ...
    def test_url2path_justDomain(self):
        f = Fetcher(cache=self.cachedir)
        self.assertEqual(f._url2path("https://www.google.com"), self.cachedir / "https_www.google.com")

    def test_url2path_noSchema(self):
        f = Fetcher(cache=self.cachedir)
        self.assertEqual(f._url2path("//www.google.com"), self.cachedir / "_www.google.com")

    def test_url2path_withPath(self):
        f = Fetcher(cache=self.cachedir)
        self.assertEqual(
            f._url2path("https://www.google.com/path/file"), self.cachedir / "https_www.google.com_path_file"
        )
    ...
    def test_response2namespace_text(self):
        ...
        self.assertNsEqual(
            f._response2namespace(response),
            """\
            url: http://mysite.com/path/page
            status_code: 200
            headers:
